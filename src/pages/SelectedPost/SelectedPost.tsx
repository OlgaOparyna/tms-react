...
const SelectedPost = ()=>{
  return <div className={styles.container}>
    ...
    <div className={styles.mainblock}>
      <div className={styles.title}>Astronauts prep for new solar arrays on nearly seven-hour spacewalk</div>
      <img className={styles.image} src="https://thumbs.dreamstime.com/b/environment-earth-day-hands-trees-growing-seedlings-bokeh-green-background-female-hand-holding-tree-nature-field-gra-130247647.jpg" alt=" "/>
    ...
    <div className={styles.buttons}>
      ...
      <div>
        <Button title={<div className={styles.right_buttons}>
          <BookmarkIcon />
          <div>Add to favorites</div>
        </div>} onClick={() => {}} type={ButtonType.Secondary} className={styles.buttonAdd}/>
      </div>
    </div>
  </div>
}
